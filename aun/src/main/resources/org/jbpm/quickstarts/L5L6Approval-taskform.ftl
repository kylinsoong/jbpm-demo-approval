<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("_isL5L6Approval");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid _isL5L6Approval");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Aun.L5L6Approval
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">_isL5L6Approval</label>
                            		<div class="div_checkbox">
                              		<input name="_isL5L6Approval" type="checkbox" class="checkbox" id="_isL5L6Approval" value="${_isL5L6Approval}" />
                            		</div>
